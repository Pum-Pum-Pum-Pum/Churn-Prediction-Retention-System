...
def main():
    ...
    print("=== BOOSTING CHALLENGER STEP 2: GRADIENT BOOSTING THRESHOLD REVIEW ===")
    ...
    print("\n=== WHAT TO COMPARE ===")
    print("1. Does threshold tuning unlock a better operating point than its default 0.50 behavior?")
    print("2. Can Gradient Boosting match Random Forest recall at acceptable precision?")
    print("3. Is there a balanced threshold worth carrying forward to final holdout comparison?")
